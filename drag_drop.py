...
class MainWidget(QMainWindow):
    def __init__(self):
        ...
        self.file_display_text.move(self.rect().width()/2-text_field_size[0]/2,widget_buffer-text_field_size[1]/2)
        self.file_display_text.resize(text_field_size[0],text_field_size[1])

        self.file_display_label = QLabel('Center', self)
        self.file_display_label.move(self.rect().width()/2-self.file_display_label.rect().width()/2,widget_buffer-text_field_size[1]/2-25)
        self.file_display_label.setText("File To Duplicate:")

        text_field_size = (100,30)
        self.copy_amount_text = QTextEdit(self)
        self.copy_amount_text.move(self.rect().width()/2-text_field_size[0]/2,self.rect().height()/2-text_field_size[1]/2)        
        ...
        self.copy_amount_label.move(self.rect().width()/2-self.copy_amount_text.rect().width()/2,self.rect().height()/2-text_field_size[1]/2-25)
        self.copy_amount_label.setText("File To Duplicate:")
        ...
        self.duplicate_button.move(self.rect().width()/2-self.duplicate_button.rect().width()/2,self.rect().height()-widget_buffer-self.duplicate_button.rect().height()/2)
